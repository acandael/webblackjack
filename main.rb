...
helpers do
  ...
  def card_image(card) # ['H', '4']
    ...
    "<img src='/images/cards/#{suit}_#{value}.png' class='card_image' />"
  end
...
post '/bet' do
  if params[:bet_amount].nil? || params[:bet_amount].to_i == 0
    ...
    halt erb(:bet)
  elsif params[:bet_amout].to_i > session[:player_pot]
    @error = "Bet amount cannot be greater then what you have ($#{session[:player_pot]})"
    halt erb(:bet)
  else # happy bet
